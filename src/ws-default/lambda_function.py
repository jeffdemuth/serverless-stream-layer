...
def lambda_handler(event, context):
    ...
    for x in range(70, 175):
        ...
        #client.batch_update_device_position( TrackerName='mytracker', Updates=[ { 'DeviceId': 'MoonCake', 'Position': [ float(str(x) + '.57909994591'), -16.585220799794 ], 'SampleTime': datetime.datetime.now() }])
